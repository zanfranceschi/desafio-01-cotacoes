...
{
    public class CotacaoInProcCommunicationWorker
        : BackgroundService
    {
        //private readonly ConcurrentQueue<SolicitacaoCotacao> _solicitacoes;
        private readonly HttpClient _httpClient;
        private readonly ILogger<CotacaoInProcCommunicationWorker> _logger;
        private readonly Random _random = new Random();

        public CotacaoInProcCommunicationWorker(
            //ConcurrentQueue<SolicitacaoCotacao> solicitacoes,
            HttpClient httpClient,
            ILogger<CotacaoInProcCommunicationWorker> logger)
        {
